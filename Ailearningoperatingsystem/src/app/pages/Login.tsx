                    ...
                    <form noValidate onSubmit={(e) => e.preventDefault()} className="bg-white/60 backdrop-blur-2xl rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] border border-white/70 p-8 sm:p-10">
                            ...
                            <div className="space-y-3.5">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-12 rounded-xl bg-[#f3f4f6] border-0 pl-11 text-sm placeholder:text-[#9ca3af] outline-none focus:ring-2 focus:ring-[#08BD80]/30 transition-shadow"
                                    />
                                </div>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-12 rounded-xl bg-[#f3f4f6] border-0 pl-11 pr-11 text-sm placeholder:text-[#9ca3af] outline-none focus:ring-2 focus:ring-[#08BD80]/30 transition-shadow"
                                    />
                                ...
                                <div className="flex justify-end">
                                    <button type="button" className="text-xs font-semibold text-[#3C4852] hover:text-[#08BD80] transition-colors">Forgot password?</button>
                                </div>
                                <button type="button" onClick={handleEmailLogin} disabled={isLoading} className="w-full h-12 rounded-xl bg-[#1a1a2e] hover:bg-[#2d2d44] text-white font-semibold text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2">
                        ...
                        {method === 'phone' && step === 'input' && (
                            <div className="space-y-3.5">
                                ...
                                <button type="button" onClick={handleSendOTP} disabled={isLoading} className="w-full h-12 rounded-xl bg-[#1a1a2e] hover:bg-[#2d2d44] text-white font-semibold text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2">
                        ...
                        {method === 'phone' && step === 'otp' && (
                            <div className="space-y-4">
                                <button type="button" onClick={() => { setStep('input'); setOtp(''); setDemoOtp(''); setError(''); }} className="flex items-center gap-1 text-sm text-[#6b7280] hover:text-[#1a1a2e] transition-colors">
                                    <ChevronLeft className="w-4 h-4" /> Change number
                                </button>
                                <p className="text-sm text-center text-[#6b7280]">
                                    Code sent to <span className="font-semibold text-[#1a1a2e]">+91 {phone}</span>
                                </p>
                                {demoOtp && (
                                ...
                                <button type="button" onClick={handleVerifyOTP} disabled={isLoading} className="w-full h-12 rounded-xl bg-[#1a1a2e] hover:bg-[#2d2d44] text-white font-semibold text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2">
                                    {isLoading ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : 'Verify & Login'}
                                </button>
                                <button type="button" onClick={handleSendOTP} className="text-sm text-[#08BD80] font-medium hover:underline w-full text-center">Resend OTP</button>
                            </div>
                        )}
                        ...
                        <div className="flex items-center justify-center gap-3">
                            <button type="button" onClick={handleGoogleLogin} className="flex-1 h-12 bg-white rounded-xl border border-[#e5e7eb] hover:border-[#d1d5db] hover:shadow-sm transition-all flex items-center justify-center">
                            ...
                            <button type="button" onClick={() => { setMethod(method === 'email' ? 'phone' : 'email'); setStep('input'); setError(''); }} className="flex-1 h-12 bg-white rounded-xl border border-[#e5e7eb] hover:border-[#d1d5db] hover:shadow-sm transition-all flex items-center justify-center">
                        ...
                        <p className="text-center text-sm text-[#6b7280] mt-6">
                            ...
                            <Link to="/signup" className="font-semibold text-[#08BD80] hover:underline">Sign up</Link>
                        </p>
                    </form>
                </div>
            </div>
